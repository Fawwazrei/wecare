...
<div class="card mt-5">
  	<div class="card-header bg-success text-white text-start" width="200">
    Data Performance
	<a class="btn btn-warning" aria-current="page" href="upload.php">Upload</a>
  
  </div>
              <div class="dropdown">
                <a class="nav-link active text-start dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"> WeCare </a>

                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <li><a class="dropdown-item" href="view.php">Week 1</a></li>
                  <li><a class="dropdown-item" href="week2.php">Week 2</a></li>
...
<?php
    include "koneksi.php";
    $no=1;
    $tampil = mysqli_query ($koneksi, "SELECT * from tweek2");
