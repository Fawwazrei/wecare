...
<body>
            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  ...
                  <li><a class="dropdown-item" href="upload.php">Update</a></li>
                </ul>
              </div>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <li><a class="dropdown-item" href="#">Agutus</a></li>
...
<select id="bulan" name="bulan">
  ...
  <!-- <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <li><a class="dropdown-item active" href="week2.php">Week 2</a></li>
